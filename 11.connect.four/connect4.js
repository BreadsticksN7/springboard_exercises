...
function makeBoard() {
    ...
    //pulled array.from({}) from solution, not sure I understand how it identified length as an actual length attribute and not
    // as a generic [key] to reference.  (ie title: boardWidth doesn't work but length: does.  how/why?  tried using something
    // like boardWidth.push(...gameBoard), thinking it would [,,,,,,])
  };
}
